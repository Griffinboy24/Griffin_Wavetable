...
//---------------------------------------------------------------------------
// ResamplerFlt Class Declaration
//---------------------------------------------------------------------------
...
private:
    ...
    long               _pitch;      // Current pitch (0x10000 = 1 octave up, 0 = natural)
    long               _buf_len;    // Block length for processing (downsampled size)
    long               _fade_pos;
    bool               _fade_flag;
