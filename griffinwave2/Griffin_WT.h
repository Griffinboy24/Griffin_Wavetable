...
#define M_PI 3.14159265358979323846
    ...
    struct Griffin_WT : public data::base
    {
        ...
        //===============================================================
        // In your project's file (e.g. in your Griffin_WT class)
        void prepare(PrepareSpecs specs)
        {
            ...
            // Initialize the mip-map with external FIR coefficients.
            // Notice: we now use rspl::MIP_MAP_FIR_COEF_ARR instead of the removed _fir_mip_map_coef_arr.
            mipMap.init_sample(
                totalTableLen,
                rspl::InterpPack::get_len_pre(),
                rspl::InterpPack::get_len_post(),
                12, // number of mip-map levels (same as test_saw)
                rspl::MIP_MAP_FIR_COEF_ARR,  // Use external FIR array
